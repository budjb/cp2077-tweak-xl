...
bool Red::TweakDBReflection::RegisterRecordInfo(Core::SharedPtr<TweakDBRecordInfo> aRecordInfo)
{
    std::unique_lock  lockRW(m_mutex);
    return m_resolved.insert({aRecordInfo->GetName(), aRecordInfo}).second;
}
