...
struct source_with_package_body : star<not_at<tao::pegtl::eof>, source_with_package_member, _> {};
...
struct source_no_package_body : star<not_at<tao::pegtl::eof>, source_no_package_member, _> {};
struct source_no_package : seq<not_at<package_stmt>, source_no_package_body> {};

struct source : seq<_, sor<source_with_package, source_no_package>, tao::pegtl::eof> {};
