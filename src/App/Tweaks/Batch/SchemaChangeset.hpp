...
public:
    ...
    {
        /**
         * @brief The unmodified name of the record type as parsed from a Tweak file.
         */
        std::string name;
...
private:
     ...
     */
    static bool IsEqual(const Red::CBaseRTTIType* aType, const Red::InstancePtr<>& aLhs, const Red::InstancePtr<>& aRhs);
